...
let FSHADER_SOURCE =
 ...
 function main(){
    ...
    document.onkeydown = function (ev) {
        keydown(ev, gl, n, u_ViewMatrix,u_ProjMatrix,u_ModelMatrix,canvas);
    };
    //指定清空<canvas>颜色
    gl.clearColor(0.0, 0.0, 0.0, 1.0);
    draw(gl, n, u_ViewMatrix,u_ProjMatrix,u_ModelMatrix,x,y,z,canvas);
 ...
 //执行绘制
function draw(gl, n, u_ViewMatrix,u_ProjMatrix,u_ModelMatrix,x,y,z,canvas) {
    let Mmatrix = getModelMatrix(x,y,z)
...
function keydown(ev, gl, n, u_ViewMatrix,u_ProjMatrix,u_ModelMatrix,canvas) {
